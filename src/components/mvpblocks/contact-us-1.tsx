        ...
        <div className="border-border/40 bg-secondary/20 mx-auto max-w-5xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
          <div className="grid md:grid-cols-2">
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              >
                <h2 className="text-green-500 mb-2 bg-gradient-to-r bg-clip-text text-4xl font-bold tracking-tight md:text-5xl">
                  Contact
                </h2>
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="w-full bg-gradient-to-br from-green-500 to-green-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
                  >
                    {isSubmitting ? (
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#22c55e] to-[#15803d]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  Bringing you the best tools for a thriving farm.
                  <div className="absolute -right-20 -bottom-20 z-10 mx-auto flex h-full w-full max-w-[300px] items-center justify-center transition-all duration-700 hover:scale-105 md:-right-28 md:-bottom-28 md:max-w-[550px]">
                    <Earth
                      scale={1.1}
                      baseColor={[0.13, 0.8, 0.38]}     
                      markerColor={[0, 0, 0]}           
                      glowColor={[0.3, 1, 0.5]}         
                    />
                  </div>
